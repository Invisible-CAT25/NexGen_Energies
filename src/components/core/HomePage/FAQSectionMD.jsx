...
//       <h2 className="text-[2.5rem] font-bold text-center mb-10">
...
//           <div
//             key={index}
//             className="bg-white border border-gray-200 rounded-lg shadow-md p-5 transition-all duration-300 hover:shadow-lg"
//           >
//             <button
//               onClick={() => toggleFAQ(index)}
//               className="w-full flex justify-between items-center text-left font-medium text-lg text-gray-900 focus:outline-none"
...
//           className="w-full md:w-1/2 mx-auto block p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-green-400 focus:border-green-500 transition-all"
//           value={search}
...
//           <p className="col-span-2 text-center text-gray-500">No FAQs match your search.</p>
//         )}
//       </div>
//     </section>
//   );
    ...
    <section className="w-11/12 mx-auto mt-20 px-4 md:px-8" aria-label="Frequently Asked Questions">
      ...
      <div className="flex justify-center mb-8">
        <input
          ...
          value={search}
          onChange={(e) => setSearch(e.target.value)}
          className="w-full max-w-md px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-green-400 transition"
        />
      </div>
